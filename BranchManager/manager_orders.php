...
<head>
  ...
  <link rel="stylesheet" href="manager_orders.css">
...
<body>
  ...
  <div class="sidebar">
    ...
    <div class="sidebar-bottom">
      ...
      <a href="manager_orders.php" class="active">Create Order</a>
  ...
  <div class="main">
    ...
    <form method="post" action="manager_orders.php" class="order-form">
...
$(document).ready(function () {
    ...
    $('#mobileNumber').on('blur', function () {
        ...
        $.getJSON('manager_orders.php', { action: 'lookup', mobile: mobile }, function (data) {
